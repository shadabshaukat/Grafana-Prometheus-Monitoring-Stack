...
load_env() {
  ...
  : "${OCI_PG_DBSYSTEM_OCID:=}"
  : "${OCI_PROM_ENABLED:=false}"
  ...
  : "${OCI_PROM_SCRAPE_TARGETS:=}"
  : "${OCI_PROM_REGION:=${OCI_REGION}}"
  : "${OCI_PROM_COMPARTMENT_OCID:=${OCI_PG_COMPARTMENT_OCID}}"
  : "${OCI_PROM_DBSYSTEM_ID:=${OCI_PG_DBSYSTEM_OCID}}"
  : "${OCI_PROM_DBSYSTEM_IDS:=${OCI_PROM_DBSYSTEM_ID}}"
